...
const int CORDIC_MM_BASE = 0x10000000;
const int CORDIC_MM_SIZE = 0x0000000C;
const int CORDIC_MM_MASK = 0x00000010;

const int EXP_MM_BASE = 0x20000000;
const int EXP_MM_SIZE = 0x0000000C;
const int EXP_MM_MASK = 0x00000010;

const int LOG_MM_BASE = 0x30000000;
const int LOG_MM_SIZE = 0x0000000C;
const int LOG_MM_MASK = 0x00000010;
